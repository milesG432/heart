        ...
        <div class="col-sm-12 col-lg-3">
            <div class="card h-100" >
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="/pulseoffice" class="mt-auto  btn" style="background-color: #da587d">Learn more</a>
                </div>
            </div>
        </div>        
        <div class="col-sm-12 col-lg-3">
            <div class="card h-100" >
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="/pulsestore" class="mt-auto  btn" style="background-color: #8b6e95">Learn more</a>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-lg-3">
            <div class="card h-100" >
                <img class="card-img-top" id="cardImg" src="/img/wwear.jpeg" alt="Card image cap">
                <div class="card-body d-flex flex-column">
                    <br><h5 class="card-title">Pulse Workwear</h5>
                    <p class="card-text">We can provide detailed and useful backoffice and web data for your workwear business.</p>
                    <a href="/pulseoffice" class="mt-auto btn" style="background-color: #216a80"">Learn more</a>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-lg-3">
            <div class="card h-100">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="https://twitter.com/heart_systems?lang=en" class="mt-auto btn" style="background-color: #16A89D">Follow</a>
                </div>
            </div>
        </div>
    </div>
